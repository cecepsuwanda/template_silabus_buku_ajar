...
\begin{itemize}
  \item Oracle Java Documentation: https://docs.oracle.com/javase/
  \item JUnit 5 User Guide: https://junit.org/junit5/docs/current/user-guide/
  \item Refactoring Catalog: https://refactoring.com/catalog/
\end{itemize}
