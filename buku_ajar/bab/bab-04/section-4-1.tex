...
\begin{konsep}
\textbf{Encapsulation} adalah prinsip OOP yang menggabungkan data (attributes) dan perilaku (methods) dalam satu class, sekaligus menyembunyikan detail internal dari akses langsung luar. Tujuannya adalah menjaga \textit{class invariant} agar data selalu dalam kondisi valid.
\end{konsep}
