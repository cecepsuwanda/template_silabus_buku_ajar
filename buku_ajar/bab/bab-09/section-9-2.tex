...
\begin{rangkuman}
Exception handling menjaga program tetap stabil saat terjadi kesalahan. Dengan custom exception dan try-with-resources, aplikasi menjadi lebih robust dan mudah dipelihara.
