...
\begin{konsep}
\textbf{Exception} adalah kondisi tidak normal yang terjadi saat program berjalan. Exception handling membantu program tetap stabil dan memberikan pesan kesalahan yang jelas.
\end{konsep}
