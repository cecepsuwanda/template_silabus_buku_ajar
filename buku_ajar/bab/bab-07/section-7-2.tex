...
\begin{aktivitas}
  ...
  \item \textbf{Implementasi}: Buat interface \class{Notifikasi} dan class \class{EmailNotifikasi}, \class{SMSNotifikasi}.
...
\begin{rangkuman}
Abstract class menyediakan dasar perilaku dan state bersama, sedangkan interface menyediakan kontrak untuk perilaku. Keduanya mendukung polymorphism dan desain yang fleksibel.
