...
\begin{rangkuman}
Polymorphism memungkinkan satu interface digunakan untuk banyak bentuk objek. Overloading terjadi di compile-time, sedangkan overriding terjadi di runtime melalui dynamic dispatch.
